...
Landing page institucional desenvolvida com **React + Vite + Tailwind CSS + Framer Motion** para apresentar a HRL com um visual moderno, tecnológico e responsivo.
